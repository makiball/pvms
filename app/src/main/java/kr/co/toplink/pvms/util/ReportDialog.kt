...
import kr.co.toplink.pvms.databinding.ReportDialogBinding
...
class ReportDialog(private val context : AppCompatActivity) {
    ...
    fun show(content : String) {
        binding = ReportDialogBinding.inflate(context.layoutInflater)
        ...
        binding.ok.setOnClickListener {
            ...
            val msg = binding.msgCont.text.toString()
